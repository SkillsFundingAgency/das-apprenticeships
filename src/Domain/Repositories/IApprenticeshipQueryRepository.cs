...
public interface IApprenticeshipQueryRepository
{
    ...
    Task<PagedResponse<DataTransferObjects.Apprenticeship>> GetAllForAcademicYear(long ukprn, DateRange academicYearDates,int page, int? pageSize, int limit, int offset);
