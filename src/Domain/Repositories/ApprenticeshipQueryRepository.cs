...
public class ApprenticeshipQueryRepository : IApprenticeshipQueryRepository
{
    ...
    public async Task<PagedResponse<DataTransferObjects.Apprenticeship>> GetAllForAcademicYear(long ukprn, DateRange academicYearDates, int page, int? pageSize, int limit, int offset)
    {
        ...
        return new PagedResponse<DataTransferObjects.Apprenticeship>
        {
