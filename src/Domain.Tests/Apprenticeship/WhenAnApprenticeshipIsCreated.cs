...
namespace SFA.DAS.Apprenticeships.Domain.UnitTests.Apprenticeship
{
    ...
    public class WhenAnApprenticeshipIsCreated
    {
        ...
        {
            var apprenticeship = _apprenticeshipFactory.CreateNew("1234435", "TRN", new DateTime(2000, 10, 16), "Ron", "Swanson", _fixture.Create<decimal?>(), _fixture.Create<decimal?>(), _fixture.Create<decimal>(), _fixture.Create<string>());
