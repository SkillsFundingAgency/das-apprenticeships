...
namespace SFA.DAS.Apprenticeships.Command.AddPriceHistory
{
    public class CreateApprenticeshipPriceChangeCommandHandler : ICommandHandler<CreateApprenticeshipPriceChangeRequest>
    {
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            apprenticeship.AddPriceHistory(command.TrainingPrice, command.AssessmentPrice, command.TotalPrice, command.EffectiveFromDate, DateTime.Now, PriceChangeRequestStatus.Created, command.Reason);
